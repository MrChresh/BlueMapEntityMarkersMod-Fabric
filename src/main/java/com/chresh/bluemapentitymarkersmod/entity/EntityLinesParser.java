...
import com.chresh.bluemapentitymarkersmod.util.ParsingContext;

public class EntityLinesParser {
    ...
    public EntityLinesParser(List<MarkerGroup> markerGroups) {
        this.markerGroups = markerGroups;
    }

    public EntityLinesParseResult parse(String[] lines) {
        ...
        return state == ParseStates.INVALID
                ? new EntityLinesParseResult(null, "", "")
                : context.buildResult();
    }
